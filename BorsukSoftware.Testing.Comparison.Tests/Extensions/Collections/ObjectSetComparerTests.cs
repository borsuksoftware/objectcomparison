...
{
    public class ObjectSetComparerTests
    {
        [Fact]
        ...
        public void AdditionalKey()
        {
            ...
            additionalKeys.Should().BeEquivalentTo(new[] { new KeyValuePair<string, object>("KeyPart1", "200"), new KeyValuePair<string, object>("KeyPart2", "Macro") });
        }
        ...
        public void MissingKey()
        {
            ...
            missingKeys.Should().BeEquivalentTo(new[] { new KeyValuePair<string, object>("KeyPart1", "199"), new KeyValuePair<string, object>("KeyPart2", "Macro") });
        }
